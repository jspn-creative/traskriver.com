...
Intel system is disabled. To activate:
  ...
  node /Users/jspn/Documents/Sites/river-stream/.opencode/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/jspn/Documents/Sites/river-stream/.opencode/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/jspn/Documents/Sites/river-stream/.opencode/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/jspn/Documents/Sites/river-stream/.opencode/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Users/jspn/Documents/Sites/river-stream/.opencode/get-shit-done/bin/gsd-tools.cjs
