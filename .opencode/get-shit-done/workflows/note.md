...
- **Global scope**: `/Users/jspn/Documents/Sites/river-stream/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jspn/Documents/Sites/river-stream/.opencode/notes/`)
...
2. Glob `/Users/jspn/Documents/Sites/river-stream/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jspn/Documents/Sites/river-stream/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jspn/Documents/Sites/river-stream/.opencode/notes/` — works in any directory
