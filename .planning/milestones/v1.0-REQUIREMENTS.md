...
- [x] **SEC-01**: Secure the HLS stream assets so they cannot be accessed directly by unauthenticated users.
- [x] **SEC-02**: Restrict or remove the `/api/test-access` endpoint for production.
